...
function Footer() {
  return (
    <>
      <hr className="border-t-2 border-base-300 dark:border-slate-700" />
      <footer className="footer p-10 bg-base-200 text-base-content dark:bg-slate-900 dark:text-white">
        ...
        <nav>
          ...
          <a className="link link-hover hover:text-pink-500 transition-colors duration-200">About us</a>
          <a className="link link-hover hover:text-pink-500 transition-colors duration-200">Contact</a>
      ...
      <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300 dark:bg-slate-900 dark:text-white dark:border-slate-800">
        <aside className="items-center grid-flow-col">
          ...
          <p>BookStore Industries Ltd. <br/>Providing reliable knowledge since 1992</p>
        </aside> 
        <nav className="md:place-self-center md:justify-self-end">
          <div className="grid grid-flow-col gap-4">
            <a className="hover:text-pink-500 transition-colors duration-200 cursor-pointer">
